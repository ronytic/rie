...
class Backup_Database {
    ...
    public function backupTables($tables = '*') {
        try {
            ...
            $sql = 'CREATE DATABASE IF NOT EXISTS `'.$this->dbName."` DEFAULT CHARSET=utf8 COLLATE=utf8_spanish_ci ;\n\n";
            $sql .= 'USE `'.$this->dbName."`;\n\n";
            ...
            foreach($tables as $table) {
                $this->obfPrint("Sacando copia de la Tabla `".$table."`...".str_repeat('.', 50-strlen($table)), 0, 0);
    ...
    protected function gzipBackupFile($level = 9) {
        ...
        $dest =  $source . '.gz';
        $this->archivofinal=$dest;
        $this->obfPrint('Comprimiendo Archivo: ' . $dest . '... ', 1, 0);
...
$backupDatabase->obfPrint('Copia de Seguridad: ' . $result, 1);
