...
$titulo="Reporte de Productos más Vendido";
$folder="../../";
?>
...
$(document).ready(function(){
	...
	$("#formulario").submit(function(e) {
		...
		$.post("buscar.php",{'CodSucursal':CodSucursal,Estado:Estado,FechaDesde:FechaDesde,FechaHasta:FechaHasta,Detalle:Detalle,CodUsuario:CodUsuario},function(data){
			$("#respuesta").html(data);
		});
    })
	// .submit();
