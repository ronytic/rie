...
<table class="table table-hover table-bordered table-striped table-table-condensed">
	...
	foreach($su as $d){$i++;
		...
		$us=$usuario->mostrarTodoRegistro("Cod=".$d['CodUsuario']);
		$us=array_shift($us);
        	...
        	<tr>
            	...
            	<td class="small">
					<table class="table table-bordered">
						...
						<tr>
							<td class=" resaltar" width="30%">Cliente: </td>
						...
						<tr>
							...
							<td class=""><span class="badge badge-success"><?php echo capitalizar($us['Nombres']." ".$us['Apellidos'])?></span></td>
						</tr>
						<tr>
				...
				?>
				<td class="text-center">
					<a href="../../ventas/registro/ver.php?Cod=<?php echo $d['CodVenta']?>" class="btn btn-success btn-xs " title="Ver" rel="<?php echo $d['CodVenta']?>" target="_blank">
