        ...
        ?>
        	<tr>
                ...
                <td class="text-center">
					...
					?>
                	<a href="eliminar.php?Cod=<?php echo $d['CodSalida']?>" class="btn btn-<?=$BtnEstado;?> btn-xs eliminarDatos" title="Eliminar" rel="<?php echo $d['CodSalida']?>" data-tituloestado="<?=$TituloEstado;?>" data-estado="<?=$Estado;?>">
