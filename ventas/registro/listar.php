...
$titulo="Listado de Ventas de Productos";
$folder="../../";
?>
...
$(document).ready(function(){
	...
	$("#formulario").submit(function(e) {
		...
		$.post("buscar.php",{'CodSucursal':CodSucursal,CodCliente:CodCliente,Estado:Estado,FechaDesde:FechaDesde,FechaHasta:FechaHasta,Detalle:Detalle},function(data){
			$("#respuesta").html(data);
		});
    })
	// .submit();
